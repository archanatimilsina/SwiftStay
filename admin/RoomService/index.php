...
<td scope="row">
<a href="edit.php?id=<?php echo $data['rid'];?>"><button class="actn-btn edit-btn">Edit</button></a>
<a href="delete.php?id=<?php echo $data['rid'];?>"><button class="actn-btn del-btn">Delete</button></a>
</td>
</tr>
    <?php
}
