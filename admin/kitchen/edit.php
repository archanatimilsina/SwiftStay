...
<div class="container">
  ...
  {
    $id=$_GET['id'];
    $select="SELECT * FROM kitchen where kid='$id'";
...
$query1="UPDATE kitchen SET name='$name',address='$address',phone='$phone',email='$email' Where kid='$id'";
