...
<head>
    ...
    <title>Reception Edit Page</title>
    <style>
        *
        {
            margin: 0;
...
<div class="container">
  ...
  {
    $id=$_GET['id'];
    $select="SELECT * FROM reception where rid='$id'";
...
$query1="UPDATE reception SET name='$name',address='$address',phone='$phone',email='$email' Where rid='$id'";
