...
$query1="INSERT INTO room_booking (name,address,city,phone,email,cin,cout,members,room_type,no_of_room) VALUES ('$name','$address','$city','$phoneno','$email','$cin','$cout','$members','$rt','$nr')";
